...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-yellow-500 to-orange-600 rounded-3xl shadow-xl p-8 text-white mb-8">
        ...
        <p class="mt-3 text-yellow-100">
            Update employee attendance details, working hours, shift, and status.
        </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="Morning"
                            {{ old('shift', $attendance->shift) == 'Morning' ? 'selected' : '' }}>
                            Morning
                        </option>

                        <option value="Afternoon"
                            {{ old('shift', $attendance->shift) == 'Afternoon' ? 'selected' : '' }}>
                            Afternoon
                        </option>

                        <option value="Evening"
                            {{ old('shift', $attendance->shift) == 'Evening' ? 'selected' : '' }}>
                            Evening
                        </option>

                        <option value="Night"
                            {{ old('shift', $attendance->shift) == 'Night' ? 'selected' : '' }}>
                            Night
                        </option>
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="Half Day"
                            {{ old('status', $attendance->status) == 'Half Day' ? 'selected' : '' }}>
                            Half Day
                        </option>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border-gray-300 focus:ring-2 focus:ring-blue-500">{{ old('notes', $attendance->notes) }}</textarea>
